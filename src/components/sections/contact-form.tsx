    ...
    <section id="contact" className="section">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="bg-card border border-border rounded-xl p-8">
          <form
            action="mailto:rushikeshkharode9@gmail.com"
            method="post"
            encType="text/plain"
            className="space-y-6"
          >
            ...
            <div>
              ...
              <Textarea id="message" name="body" placeholder="Tell me about your project..." required className="bg-secondary border-2 border-border min-h-[150px] focus:border-primary focus:ring-primary/20" />
            </div>
